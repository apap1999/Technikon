...
public class PropertyFunctionalitiesImpl extends  RepositoryImpl<PropertyFunctionalities, Long> implements PropertyFunctionalitiesRepository{
	...
	public List<PropertyFunctionalities> read(int pageNumber, int pageSize) {
		...
		try {
			...
			PropertyFunctionalitiesList.forEach(property_functionalities->System.out.println("{" +
					property_functionalities.getPropertyId() +" " +
					property_functionalities.getPropertyAddress() + " " + 																							  
	...
	public Optional<PropertyFunctionalities> read(Long tId) {
		...
		try {
			...
			System.out.println("{" + propertyFunctionalities.getPropertyId() + " " +
									 propertyFunctionalities.getPropertyAddress() + " " + 
